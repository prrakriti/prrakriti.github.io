    ...
    <div className="bg-gradient-to-b from-[#262A4B] via-[#31586D] to-[#419A9F]">
      <div className="max-w-4xl mx-auto px-5 pt-16 ">
        <div className="text-center">
          ...
          <p className="max-w-md mx-auto mt-2 text-gray-200">
        ...
        <div className="grid md:grid-cols-2 gap-10 mt-10">
          <div className="flex gap-4 items-start">
            <span className="text-blue-600 bg-slate-300 p-3 rounded-full">
              <svg
                width="15"
                height="15"
                viewBox="0 0 15 15"
        ...
        <div className="lg:ml-6 lg:col-start-2 lg:max-w-2xl mt-20 pb-20">
          ...
          <ul className="mt-8 space-y-3 font-medium">
            <li className="flex items-start lg:col-span-1">
              <div className="flex-shrink-0">
                <svg
                  className="w-5 h-5 text-blue-600 bg-slate-300  rounded-full"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path
              ...
              <p className="ml-3 leading-5 text-gray-200">
